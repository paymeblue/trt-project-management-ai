      ...
      <div className="space-y-3">
        ...
        {rows.map((p) => (
          <a
            ...
            className="flex items-center justify-between rounded-xl border border-gray-200 bg-white px-5 py-4 text-sm shadow-sm hover:border-blue-400 hover:shadow-md transition"
          >
