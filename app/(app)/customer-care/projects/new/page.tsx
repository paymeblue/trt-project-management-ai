...
export default async function ProjectIntakePage() {
  ...
  return (
    <div className="mx-auto max-w-xl px-6 py-8">
      <a href="/customer-care/dashboard" className="text-sm text-primary hover:underline">
        ← Dashboard
      </a>
      <h1 className="mb-1 mt-2 text-2xl font-bold text-gray-900">New Project</h1>
      <p className="mb-6 text-sm text-gray-500">
        Capture the client&apos;s intent from the intake call. The project starts unpaid — Head of
        Operations confirms payment and sets the timeline next.
      </p>
